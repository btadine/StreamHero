...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
  ...
  [[self.messagesFirebase childByAutoId] setValue:@{@"user_id" :self.userId ,
                                                    @"username":self.name,
                                                    @"text": textField.text}];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.name = [[NSUserDefaults standardUserDefaults]
...
- (id<JSQMessageBubbleImageDataSource>)collectionView:(JSQMessagesCollectionView *)collectionView messageBubbleImageDataForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([message.senderId isEqualToString:self.userId]) {
                   ...
                   layout:(JSQMessagesCollectionViewFlowLayout *)collectionViewLayout heightForMessageBubbleTopLabelAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[currentMessage senderId] isEqualToString:self.userId]) {
        return 0.0f;
    }
